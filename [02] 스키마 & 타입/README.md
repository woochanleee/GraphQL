...
1. [타입 시스템](#타입-시스템)
2. [타입 언어](#타입-언어)
3. [객체 타입과 필드](#객체-타입과-필드)
4. [인자](#인자)
5. [쿼리 타입 & 뮤테이션 타입](#쿼리-타입-&-뮤테이션-타입)
6. [스칼라 타입](#스칼라-타입)
7. [열거형 타입](#열거형-타입)
8. [리스트와 Non-Null](#리스트와-Non-Null)
9. [인터페이스](#인터페이스)
10. [유니온 타입](#유니온-타입)
11. [입력 타입](#입력-타입)
...
입력 객체 타입의 입력란은 입력 객체 타입을 참조할 수 있지만, 입력 및 출력 타입을 스키마에 혼합할 수는 없습니다. 또한 입력 객체 타입은 필드에 인자를 가질 수 없습니다.
